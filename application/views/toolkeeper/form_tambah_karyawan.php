...
<div class="container-fluid"> 
	<div class="card shadow mb-4">
        ...
        <form action="<?php echo base_url();?>toolkeeper/tambah_karyawan" method="post">
            <div class="form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">NIK<span class="required"></span></label>
                <div class="col-md-6 col-sm-6" >
                    <input class="form-control" name="nik" style="border-radius: 20px;" placeholder="Masukan NIK" type="text"onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ@.1234567890',this") required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">Nama Karyawan<span class="required"></span></label>
                <div class="col-md-6 col-sm-6">
                    <input class="form-control" name="nama_karyawan" style="border-radius: 20px;" placeholder="Masukan Nama Karyawan" type="text"onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ@.1234567890',this") required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">Jenis Kelamin<span class="required"></span></label>
                <div class="col-md-6 col-sm-6">
                    <select name="jenis_kelamin" style="border-radius: 20px;" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6">
                    <select name="status" style="border-radius: 20px;" class="form-control" required>
