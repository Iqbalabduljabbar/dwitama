<div class="container-fluid"> 
	<div class="card shadow mb-4">
        ...
        <form action="<?php echo base_url();?>toolkeeper/tambah_tools_hp" method="post">
            <div class="form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">Kode Tools<span class="required"></span></label>
                <div class="col-md-6 col-sm-6">
                    <input class="form-control" style="border-radius:20px" name="kode_tools_hp" placeholder="Masukan Kode Tools" type="text"onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ@.1234567890',this") required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">Nama Tools<span class="required"></span></label>
                <div class="col-md-6 col-sm-6">
                    <input class="form-control" style="border-radius:20px" name="nama_tools_hp" placeholder="Masukan Nama Tools" type="text"onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ@.1234567890',this") required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">Frekuensi Pemakaian<span class="required"></span></label>
                <div class="col-md-6 col-sm-6">
                    <select name="frek_pem_hp"  class="form-control" style="border-radius:20px" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6">
                    <input class="form-control" style="border-radius:20px" name="qty_hp" placeholder="Masukan Kuantitas Tools" type="number"onKeyPress="return goodchars(event,'1234567890',this") required>
                </div>
            </div>
             <div class="form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">QTY Diambil<span class="required"></span></label>
                <div class="col-md-6 col-sm-6">
                    <input class="form-control" style="border-radius:20px" name="qty_diambil_hp" placeholder="Masukan Kuantitas Tools" type="number"onKeyPress="return goodchars(event,'1234567890',this") required>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6">
                    <select name="rak_hp" style="border-radius:20px" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6">
                    <input class="form-control" style="border-radius:20px" name="tgl_msk_hp" placeholder="Masukan Tanggal Masuk" type="date" required>
                </div>
            </div>
            <div class="form-group">
